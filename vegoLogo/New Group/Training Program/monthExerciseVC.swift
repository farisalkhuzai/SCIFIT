...
import UIKit
import Firebase
class monthExerciseVC: UIViewController, UITableViewDelegate, UITableViewDataSource {
var user:User?
    @IBOutlet weak var loading: UIActivityIndicatorView!
    @IBOutlet weak var monthTV: UITableView!
    //referance for database
    var ref:DatabaseReference!
    var selectedmonth:Exercise?
    ...
    override func viewDidLoad() {
        ...
        self.monthTV.delegate = self
        self.monthTV.dataSource = self
        loadData()
...
//                self.monthTV.reloadData()
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = monthTV.dequeueReusableCell(withIdentifier: "cell", for: indexPath) as! monthExerciseCell
        //        let diet = user?.diet
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        self.selectedmonth = user?.exercises[indexPath.row]
        self.performSegue(withIdentifier: "seguemonth", sender: nil)
    }
    
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        if segue.identifier == "seguemonth"  {
            if let destinationVC = segue.destination as? weekExerciseVC {
